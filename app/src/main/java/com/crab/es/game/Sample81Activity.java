...
public class Sample81Activity extends AppCompatActivity {
    Sample81SurfaceView mySurfaceView;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        //切换到主界面
        setContentView(R.layout.activity_sample81);
        //初始化GLSurfaceView
        mySurfaceView = new Sample81SurfaceView(this);
