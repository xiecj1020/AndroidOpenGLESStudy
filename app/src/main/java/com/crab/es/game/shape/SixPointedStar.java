...
public class SixPointedStar {
    ...
    private static final float UNIT_SIZE = 1;

    public SixPointedStar(Sample51SurfaceView mv, float r, float R, float z) {
    ...
    public void initShader(Sample51SurfaceView mv) {
        //加载顶点着色器的脚本内容
