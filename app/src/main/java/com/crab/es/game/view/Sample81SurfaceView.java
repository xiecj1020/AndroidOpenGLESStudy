...
import com.crab.es.game.shape.Cylinder;
import com.crab.es.game.shape.CylinderL;
import com.crab.es.game.shape.Triangle71;
...
public class Sample81SurfaceView extends GLSurfaceView {
    ...
    public Sample81SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, javax.microedition.khronos.egl.EGLConfig config) {
            ...
            //创建圆柱对象
            cylinder = new Cylinder(Sample81SurfaceView.this,1,1.2f,3.9f,36,textureId,textureId,textureId);
            //创建圆柱骨架对象
            cylinderl= new CylinderL(Sample81SurfaceView.this,1,1.2f,3.9f,36);
