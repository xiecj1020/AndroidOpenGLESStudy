...
public class Sample71SurfaceView extends GLSurfaceView {
    ...
    public Sample71SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, javax.microedition.khronos.egl.EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new Triangle71(Sample71SurfaceView.this);
            //打开深度检测
