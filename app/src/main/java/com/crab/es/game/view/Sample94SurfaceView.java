...
import com.crab.es.game.obj.Building;
import com.crab.es.game.obj.LoadedObjectVertexNormalTexture;
import com.crab.es.game.utils.LoadUtil;
...
public class Sample94SurfaceView extends GLSurfaceView {
    ...
    public Sample94SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo= LoadUtil.loadFromFile("ch_t.obj", Sample94SurfaceView.this.getResources(),Sample94SurfaceView.this);
            //加载纹理
