...
public class CylinderSide {
    ...
    public CylinderSide(Sample81SurfaceView mv, float scale, float r, float h, int n)
    {
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_tex_light81.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_tex_light81.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
