...
public class Sample87SurfaceView extends GLSurfaceView {
    ...
    public Sample87SurfaceView(Context context) {
        super(context);
...
//            MatrixState.setCamera(0,0,8.0f,0f,0f,0f,0f,1.0f,0.0f);
        ...
        public void onSurfaceCreated(GL10 gl, javax.microedition.khronos.egl.EGLConfig config) {
            ...
            //创建对象
            building=new Building(Sample87SurfaceView.this,0.8f,8,8);
