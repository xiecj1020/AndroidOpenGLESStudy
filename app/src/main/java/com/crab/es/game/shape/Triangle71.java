...
public class Triangle71 {
    ...
    public Triangle71(Sample71SurfaceView mv)
    {
        //初始化顶点坐标与着色数据
        initVertexData();
        //初始化着色器
    ...
    //初始化着色器
    public void initShader(Sample71SurfaceView mv)
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex71.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag71.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
