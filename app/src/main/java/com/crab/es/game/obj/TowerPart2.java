package com.crab.es.game.obj;

import android.opengl.GLES20;

import com.crab.es.game.utils.BNPosition;
import com.crab.es.game.utils.BezierUtil;
import com.crab.es.game.utils.Constant;
import com.crab.es.game.utils.MatrixState;
import com.crab.es.game.utils.ShaderUtil;
import com.crab.es.game.utils.VectorUtil;
...
public class TowerPart2 {
    ...
    public TowerPart2(Sample87SurfaceView mv,float scale, int nCol ,int nRow)
    {
        this.scale=scale;
    ...
    public void initShader(Sample87SurfaceView mv)
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_tex87.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_tex87.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
