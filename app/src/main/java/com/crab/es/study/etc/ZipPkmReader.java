...
public class ZipPkmReader {
    ...
    public void setZipPath(String path){
        Log.e("mytag",path+" set");
        this.path=path;
    }

    public boolean open(){
        Log.e("mytag",path+" open");
        ...
        try {
            if(path.startsWith("assets/")){
                ...
                Log.e("mytag",path+" is File exists->"+f.exists());
                mZipStream=new ZipInputStream(new FileInputStream(path));
            }
            return true;
        } catch (IOException e) {
            Log.e("mytag","eee-->"+e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    private boolean hasElements(){
        try {
            if(mZipStream!=null){
                ...
                Log.e("mytag","mZip entry null");
            }
        } catch (IOException e) {
            Log.e("mytag","err  dd->"+e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
