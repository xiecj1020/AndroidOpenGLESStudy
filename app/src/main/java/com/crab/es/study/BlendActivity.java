...
import com.crab.es.study.blend.WheelView;
import com.crab.es.study.filter.NoFilter;
import com.crab.es.study.utils.EasyGlUtils;
import com.crab.es.study.utils.MatrixUtils;
...
public class BlendActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSrcParamView=  findViewById(R.id.mSrcParam);
        mDstParamsView=  findViewById(R.id.mDstParam);
